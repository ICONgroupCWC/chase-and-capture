...
def retrieveRandomFromMongo(num_entries, agentID, lossFn, query=None):
    ...
    collection = db[f'mode_15_Q_Agent{agentID}'] 
...
if __name__ == "__main__":
    import wandb
    wandb.init(project="DQN Spider and Fly",name=f"adaptation_30_to_15_iter_2",save_code=True)
    ...
    INPUT_QNET_NAME = '/Users/athmajanvivekananthan/WCE/JEPA - MARL/multi-agent/PPO/bert_marl/mode15-dqn/artifacts/adaptation/780_mode15_agent_1.pt'
    ...
    samples = retrieveRandomFromMongo(10000, 1, "MSE")
    ...
    for epoch in range(EPOCHS):  # loop over the dataset multiple times
        ...
        if epoch % 10 ==0:
            torch.save(clf.state_dict(), f'artifacts/adaptation2/{epoch}_mode15_agent_1.pt')
