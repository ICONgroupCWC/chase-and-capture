...
if __name__ == "__main__":
    import wandb
    wandb.init(project="DQN Spider and Fly",name=f"classify_mode15",save_code=True)
    ...
    epochName = 15000
    INPUT_QNET_NAME = f'artifacts/models/{epochName}_mode15_agent_1.pt'
    FROM_SCRATCH = True
    ...
    for epoch in range(EPOCHS):  # loop over the dataset multiple times
        ...
        if epoch % 10 ==0:
            torch.save(clf.state_dict(), f'artifacts/{epoch}_mode15_agent_1.pt')
