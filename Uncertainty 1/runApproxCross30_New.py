...
N_SIMS = 50
INPUT_QNET_NAME = '/Users/athmajanvivekananthan/WCE/JEPA - MARL/multi-agent/PPO/bert_marl/mode30-new/artifacts/action_pred3/1_300_mode30_agent_1.pt'
...
class Network(nn.Module):
    ...
    def init_weights(self):
        # Example: Xavier initialization for the weights
        nn.init.xavier_uniform_(self.linear1.weight)
        nn.init.xavier_uniform_(self.linear2.weight)
        nn.init.xavier_uniform_(self.linear3.weight)
        nn.init.xavier_uniform_(self.linear4.weight)
        
        # Optional: Set biases to zero
...
if __name__ == "__main__":
    ...
    for experi in range(Number_of_experiments):
        ...
        with open("approx_cross_rollout_mode30_NEW.json", "w") as json_file:
