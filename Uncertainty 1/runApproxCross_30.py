...
INPUT_QNET_NAME = '/Users/athmajanvivekananthan/WCE/JEPA - MARL/multi-agent/PPO/bert_marl/mode30-dqn/bertsekas-marl/artifacts/models/4990_mode30_agent_1.pt'
#INPUT_QNET_NAME = '/Users/athmajanvivekananthan/WCE/JEPA - MARL/multi-agent/PPO/bert_marl/mode30-dqn/bertsekas-marl/artifacts/models/7960_mode30_agent_1.pt'
...
if __name__ == "__main__":
    ...
    for experi in range(Number_of_experiments):
        ...
        with open("approx_cross_rollout_4990_mode30.json", "w") as json_file:
