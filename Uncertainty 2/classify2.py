...
if __name__ == "__main__":
    ...
    epochName = 15000
    INPUT_QNET_NAME = f'/Users/athmajanvivekananthan/WCE/JEPA - MARL/multi-agent/PPO/bert_marl/mode30-dqn/bertsekas-marl/artifacts/models/7960_mode30_agent_1.pt'
    FROM_SCRATCH = False
    ...
    for epoch in range(EPOCHS):  # loop over the dataset multiple times
        ...
        if epoch % 10 ==0:
            torch.save(clf.state_dict(), f'artifacts/models/cosine5/{epoch}_mode30_agent_1.pt')
