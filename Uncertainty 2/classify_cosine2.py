...
if __name__ == "__main__":
    ...
    scheduler = torch.optim.lr_scheduler.CyclicLR(optimizer, 
                     base_lr = 1e-10, # Initial learning rate which is the lower boundary in the cycle for each parameter group
    ...
    for epoch in range(EPOCHS):  # loop over the dataset multiple times
        ...
        if epoch % 10 ==0:
            torch.save(clf.state_dict(), f'artifacts/models/cosine2/{epoch}_mode30_agent_1.pt')
