...
SEED = 42
N_SIMS_MC = 50
INPUT_QNET_NAME = deter_5050Prey_agent_1
...
def runTest(episodes_per_experiments,inputQName):
...
if __name__ == '__main__':
    ...
    for experi in range(Number_of_experiments):
        results_experiment[experi] = runTest(episodes_per_experiments, INPUT_QNET_NAME)

    with open("results_experiment_asyncAuto_2agent.json", "w") as json_file:
