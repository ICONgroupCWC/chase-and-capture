...
from src.constants import SpiderAndFlyEnv, deter_5050Prey,deter_5050Prey_Cross_13,evolvedWM, AgentType, \
    QnetType
...
N_SIMS = 50
FROM_SCRATCH = True
INPUT_QNET_NAME = evolvedWM
OUTPUT_QNET_NAME = evolvedWM
...
if __name__ == '__main__':
    steps_history = []
    steps_num = 0
    wandb.init(project="Evolved_WM",name="evolved11_on_mode11")
    ...
    for epi in range(EPOCHS):
        ...
        create_movie_clip(frames,f"evolved11_on_Mode11_{epi}.mp4")
