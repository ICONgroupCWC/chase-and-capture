    ...
    for experi in range(Number_of_experiments):
        ...
        for epi in range (episodes_per_experiments):
            ...
            if (epi+1) % 10 ==0:
                ...
                create_movie_clip(frames, f"results_experiment_sequential_rollout_Approx_Base{epi+1}.mp4", fps=10)

        env.close()
        results_experiment[experi] = steps_history

        with open("results_experiment_sequential_rollout_Approx_Base.json", "w") as json_file:
