...
if __name__ == "__main__":
    import wandb
    wandb.init(project="DQN Spider and Fly",name=f"classify_rsmProp2",save_code=True)
    ...
    optimizer = optim.RMSprop(clf.parameters(), lr=1e-4, weight_decay=1e-5)
    ...
    for epoch in range(EPOCHS):  # loop over the dataset multiple times
        ...
        if epoch % 10 ==0:
            torch.save(clf.state_dict(), f'artifacts/models/classify_rmsProp2/{epoch}_mode20_agent_1.pt')
